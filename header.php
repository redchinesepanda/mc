...
<html <?php language_attributes(); ?> <?php thrive_html_class(); ?>>
	<head>
		...
		<meta http-equiv="Content-Security-Policy" content="default-src 'none'; script-src 'self'; connect-src 'self'; img-src 'self' test.match.center; style-src 'self';base-uri 'self';form-action 'self';">
