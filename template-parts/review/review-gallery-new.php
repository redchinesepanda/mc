        ...
        <div class="legal-imageset <?php echo $args[ 'class' ]; ?>">
            <?php foreach( $args[ 'items' ] as $image ): ?>
                <div class="imageset-item">
                    <img class="item-image <?php echo $image[ 'class' ]; ?>" src="<?php echo $image[ 'src' ]; ?>" alt="<?php echo $image[ 'alt' ]; ?>" width="<?php echo $image[ 'width' ]; ?>" height="<?php echo $image[ 'height' ]; ?>" data-src="<?php echo $image[ 'data-src' ]; ?>" loading="lazy">
