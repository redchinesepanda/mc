	...
	<?php if ( !empty( $args[ 'socialLinks' ] ) ) : ?>
		<div class="author-social-links">
			<?php if ( !empty( $args[ 'socialLinks' ][ 'twitter' ] ) ) : ?>
				<a href="<?php echo $args[ 'socialLinks' ][ 'twitter' ]; ?>" class="social-links social-links-twitter" target="_blank" rel="nofollow"></a>
			<?php endif; ?>
			<?php if ( !empty( $args[ 'socialLinks' ][ 'facebook' ] ) ) : ?>
				<a href="<?php echo $args[ 'socialLinks' ][ 'facebook' ]; ?>" class="social-links social-links-facebook" target="_blank" rel="nofollow"></a>
			<?php endif; ?>
			<?php if ( !empty( $args[ 'socialLinks' ][ 'linkedin' ] ) ) : ?>
				<a href="<?php echo $args[ 'socialLinks' ][ 'linkedin' ]; ?>" class="social-links social-links-linkedin" target="_blank" rel="nofollow"></a>
			<?php endif; ?>
		</div>
	<?php endif; ?>
</div>