<div class="legal-compilation compilation-<?php echo $args['settings']['id']; ?>">
    ...
    <?php endif; ?>
    <div class="legal-compilation-info"><?php if ( !empty( $args[ 'settings' ][ 'date' ][ 'value' ] ) ) : ?>
            <div class="compilation-date"><?php echo $args[ 'settings' ][ 'date' ][ 'label' ]; ?>: <?php echo $args[ 'settings' ][ 'date' ][ 'value' ]; ?></div>
            <?php endif; ?><?php echo CompilationMain::render_attention_tooltip( $args['settings']['attention'] ); ?><?php echo CompilationMain::render_attention( $args['settings']['attention'], CompilationMain::POSITION[ 'below' ] ); ?></div>
