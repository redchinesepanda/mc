...
<?php if ( empty( $args[ 'license' ] ) ) : ?>
    <div class="bonus-button">
        <a class="legal-play <?php echo $args[ 'play' ][ 'class' ]; ?> check-oops" href="<?php echo $args[ 'play' ][ 'href' ]; ?>" <?php echo BilletMain::render_nofollow( $args[ 'nofollow' ] ); ?>><?php echo $args[ 'play' ][ 'label' ]; ?></a>
    </div>
<?php else : ?>
