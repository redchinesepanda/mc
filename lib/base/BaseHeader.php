...
class BaseHeader
{
	...
	public static function get_favicon()
	{
		if ( MultisiteMain::check_multisite() )
		{
			...
			return $site_url . "/wp-content/themes/mc-theme/assets/img/base/header/mc-favicon.svg";
		}
		
		// return LegalMain::LEGAL_ROOT . "/favicon.ico";
		return LegalMain::LEGAL_ROOT . "/wp-content/themes/mc-theme/assets/img/base/header/mc-favicon.svg";
	}
