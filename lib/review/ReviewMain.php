...
class ReviewMain
{
    ...
    public static function style_attributes( $html, $handle )
    {
        ...
        {
            return str_replace( 'rel="stylesheet"', 'rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous"', $html );
        }
